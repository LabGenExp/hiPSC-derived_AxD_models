setwd("d:/20221206_fixed_AxD_Utrecht/")
...
#10x barocde list
BarcodeList_sc = c("/mnt/d/10x_barcodes/737K-fixed-rna-profiling.txt")
#GenomeDir
...
for(i in 1:nrow(samples)) {
  ...
  cat(paste0("TrimmomaticSE -threads ",threads," -phred33 raw/",samples$LibraryName[i],"_2.fastq.gz raw/TRIM_",samples$LibraryName[i],"_2.fastq CROP:50;\n"))
  ...
  cat(paste0("~/fastq_screen_v0.11.1/fastq_screen --aligner bwa --threads ",threads,
              ...
              " raw/TRIM_",samples$LibraryName[i],"_2.fastq;\n"))
  
  cat(paste0("mv ",samples$LibraryName[i],"_2_screen* qa/fastq_screen;\n"))
  
  
  cat(paste0("unpigz -k -p ",threads," raw/",samples$LibraryName[i],"_1.fastq.gz;\n"))
  ...
  cat(paste0("pigz -p ",threads," raw/TRIM_",samples$LibraryName[i],"_2.fastq;\n"))
  cat(paste0("rm raw/",samples$LibraryName[i],"_1.fastq;\n"))
